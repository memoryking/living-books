...
try {
  ...
  const shot=async name=>{
    const selectors={'select-list':'[class*=listPrompt] > p',today:'[class*=dailyHome] > *','new-lesson':'[class*=answerPair], [class*=textPages] > p',choose:'[class*=quickSelect], [class*=characterMenu]',answer:'[class*=gradeButtons]',writing:'[class*=padWrap]','writing-answer':'[class*=padWrap]',backup:'[class*=guideProse] > h3:first-child, [class*=guideProse] > p:first-of-type, [class*=guideProse] > [class*=buttonRow]'};

...
const shots=[["today-complete",5,"오늘 학습 완료 후 다음 복습 시각 안내"],["meta-ready",4,"메타 학습 준비와 시작"],["meta-question",4,"남은 시간과 훈음 첫 글자 선택"],["meta-answer",4,"자동 평가 저장 후 다음 문제로"],['select-list',3,'전체 항목에서는 학습 목록을 먼저 선택하세요'],['today',2,'오늘 복습과 새 글자 학습 선택'],['new-lesson',1,'새 글자의 그림과 암기법 배우기'],['choose',3,'책갈피 범위를 골라 정답 없이 시험하기'],['answer',4,'정답 확인과 두 가지 자기평가'],['writing',7,'뜻과 음을 보고 직접 쓰기'],['writing-answer',7,'내 글씨 뒤에 정답을 겹쳐 비교하기'],['backup',10,'학습 기록 내보내기와 가져오기']];

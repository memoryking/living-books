...
const shots=[['select-list',3,'전체 항목에서는 학습 목록을 먼저 선택하세요'],['today',2,'오늘 복습과 새 글자 학습 선택'],['new-lesson',1,'새 글자의 그림과 암기법 배우기'],['choose',3,'책갈피 범위를 골라 정답 없이 시험하기'],['answer',4,'정답 확인과 두 가지 자기평가'],['writing',7,'뜻과 음을 보고 직접 쓰기'],['writing-answer',7,'내 글씨 뒤에 정답을 겹쳐 비교하기'],['backup',10,'학습 기록 내보내기와 가져오기']];

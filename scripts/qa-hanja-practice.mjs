// Historical selection-study UI. Current pre-study regression: qa-hanja-prestudy.mjs.
...
try {
  ...
  for(const [width,height] of [[1920,1080],[1366,768],[1280,800],[768,1024],[1024,768],[390,844],[320,568],[844,390]]) {
    ...
    await press('오늘 학습');assert.ok(await ev('document.body.innerText.includes("지금 복습")'));
